...
const numeroEntrada1 = document.getElementById('firtsNumber') as HTMLInputElement;

const numeroEntrada2 = document.getElementById('secondNumber') as HTMLInputElement;
...
const resta = () => {
    ...
    const primerNumero = document.getElementById('firtsNumber') as HTMLInputElement;
    const segundoNumero = document.getElementById('secondNumber') as HTMLInputElement;
    const resultado = document.getElementById('resultado') as HTMLElement;
